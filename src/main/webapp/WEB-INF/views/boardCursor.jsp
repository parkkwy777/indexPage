...
<div class="container" style="border solid;">
	<div>
		...
		<a href="<%= request.getContextPath() %>/Limit"><button style="background-color:green; margin-bottom:1px; color:white; float:right ">일반 페이징</button></a>
	</div>
	...
	<%@ include file="/WEB-INF/views/common/Pager2.jsp"%>
</div>
